...
<head>
  ...
  <link media="screen" rel="stylesheet" href="stylesheets/test-stylesheet.css"/>
  ...
  else if($_POST['submit'] == 'Main attribute')
  {
    ...
    $result = mysql_query($query) or die(mysql_error());      
      ...
      while($row = mysql_fetch_array($result))
      {
        ...
        else if ($mainattribute == 'intelligence') 
        {
          $varAttr = "intelligence";
        }
        ...
        <table>
          <tr>
            <td> 
              <img src="<?php echo $heroimage ?>" alt="DotA2icon"/>
            </td>
            <td>
              Name: <?php echo $name ?>
            </td>
            <td>
              - Main attribute: 
              <span class="attr attr-<?php echo $varAttr ?>">
                <?php echo $mainattribute ?>
              </span>
            </td>
          </tr>
        </table>
